...
HANDLE ConnectToRemoteStdOut( ReXeCutionerMessage* pMsg )
{
...
HANDLE ConnectToRemoteStdIn( ReXeCutionerMessage* pMsg )
{
    SECURITY_ATTRIBUTES SecAttrib = {0};
    SECURITY_DESCRIPTOR SecDesc;
    InitializeSecurityDescriptor(&SecDesc, SECURITY_DESCRIPTOR_REVISION);
...
DWORD Execute( ReXeCutionerMessage* pMsg )
{
    DWORD rc = 0;
